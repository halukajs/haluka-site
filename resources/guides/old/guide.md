...
Fully documented and functional `auth` config can be found at [Haluka App GitHub Repository Branch 1.2](https://github.com/hacktivistic/haluka-app/blob/1.2/config/auth.js)
